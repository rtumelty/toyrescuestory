...
{	
	...
	{
		return ( OPENING_SEQUENCE || TRANSACTION || CHARACTER_PASSING_ANIMATION || POPUP_UI_SCREEN || MENU_FOR_REDIRECTOR || CHARACTER_IN_MOVE || CHARACTER_CELEBRATING || SCREEN_DRAGGING || MENU_FOR_TIP || UI_CLICKED || LOADING_SAVING_MENU || TUTORIAL_MENU || TOY_LAZARUS_SEQUENCE || START_SEQUENCE || CHARACTER_BOX );
	}
	//*************************************************************//
